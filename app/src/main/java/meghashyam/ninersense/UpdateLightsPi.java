...
public class UpdateLightsPi extends AsyncTask<String, Void, String> {
    public int id,seekbar_result,floor;

    public UpdateLights.getLightsInterface activity = null;

    public UpdateLightsPi(int id, int seekbar_result, LightsFragment activity) {
        this.id = id;
    ...
    protected String doInBackground(String... strings) {
        ...
        try
        {
            ...
            URL url = new URL("http://192.168.1.3:80/lightsUpdate.php");       //RaspberryPi URL
